  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5">
      ...
      <form action="" method="POST" id="form_submit">
        <div class="mb-3">
          </br><label for="jenis" class="form-label">Pilih Jenis Pegawai </label>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="NIP" id="NIP" aria-describedby="emailHelp" <?= $nip ?> placeholder="Format pengetikan: 12345678 123456 1 123" required>
        </div>
        <div class="mb-3">
          <label for="Nama" class="form-label">Nama</label>
          <input type="text" class="form-control" name="Nama" id="Nama" aria-describedby="emailHelp" <?= $nama ?> required>
        </div>
