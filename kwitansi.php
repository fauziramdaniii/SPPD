      ...
      <table class="table">
        <thead>
          <tr>
            ...
            <th><input class="search" type="text" placeholder="Cari Kwitansi"></th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <th scope="row">1</th>
            <td>090 / /DPMPTSP.01/2021</td>
            <td>12 April 2021 </td>
            <td>Nurcahyono</td>
            <td> Rp. 2.700.000 </td>
            <td><a href="inputspt.php"> <input type="submit" name="submit" value="Ubah" />
                <input type="submit" name="submit" value="Hapus" /> <input type="submit" name="submit" value="Cetak" /> </td>
          </tr>
        </tbody>
