  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5">
      ...
      <table class="table">
        ...
        <tbody id="tampil">
          <?php
          $sppd = $conn->query("SELECT `IdSPPD`, spt.NomorS, spt.Tanggal, pegawai.Nama, `TempTujuan` FROM `sppd` inner join spt on sppd.IdSPT = spt.IdSPT inner join pegawai on spt.Kepada = pegawai.IdPegawai");
          $no = 1;
