<?php
    ...
    if (isset($_POST['search'])) {
        ...
        inner join spt on sppd.IdSPPD = spt.IdSPT 
...
?>
    <tr>
      ...
      <a href="sppd_live.php"><input id="delete" type="submit" name="submit" value="Hapus" /></a> <input type="submit" name="submit" value="Cetak" /> </td>
    </tr>
<?php }
} ?>
