  ...
  <body>
    ...
    ?>
      <tr>
        ...
        <a id="delete" href="function/pegawai_live.php?kode=<?=$data_pegawai['IdPegawai']?>"><input type="submit" name="submit" value="Hapus" data-hapus="<?=$data_pegawai['NIP']?>"/> </td>
      ...
      // custom function
			function tampil_data(pilih, search)
			{
				$.ajax({
					...
					data: {pilih: pilih, search:search},
